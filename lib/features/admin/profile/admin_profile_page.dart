                ...
                Expanded(
                  ...
                  child: _buildSection(
                    ...
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Send a password recovery link to your registered email.', style: AppTheme.bodyMedium),
                        const SizedBox(height: 24),
                        OutlinedButton.icon(
  ...
  Widget _buildSection(String title, Widget content) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(title, style: AppTheme.headingMedium.copyWith(fontSize: 14, color: AppTheme.textLight, letterSpacing: 1.2)),
